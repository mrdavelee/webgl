...
;(function($){
  ...
  Spinning.rules = {
    ...
    satelliteSize: {min: 0.02, max: 0.50, step: 0.01, precision: 2},
    satelliteSpeed: {min: 0.01, max: 1.00, step: 0.05, precision: 2},
    brightness: {min: 0.0, max: 1.0, step: 0.1, precision:1},
    quantity: {min: 0, max: 5, step: 1, precision:0},
